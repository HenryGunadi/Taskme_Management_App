...
import {ContextProps, commandContext} from './Dashboard';
...
const Command: React.FC = () => {
	...
	// use context
	const {toggleCommand} = useContext(commandContext) as ContextProps;

	return (
		<div className="w-1/2 h-1/2 border border-slate-950 rounded-md absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 flex flex-col z-50 bg-slate-50">
			{/* search bar */}
